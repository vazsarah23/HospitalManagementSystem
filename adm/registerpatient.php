...
if (isset($_POST['add_patient'])){
    ...
    $query = "insert into patients (pid,pfname,plname,phone,address,age,type,ailment,docid,dob) values(?,?,?,?,?,?,?,?,?,?)";
    $stmt = $mysqli->prepare($query);
    $rc = $stmt->bind_param('ssssssssss',$pid,$pfname,$plname,$phone,$address,$age,$type,$ailment,$docid,$dob);
    $stmt->execute();
    if($stmt)
			{
